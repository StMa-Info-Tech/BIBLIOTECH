...
def affichage_menu():
    ...
    BouttonEmprunt = CTkButton(root, text="EMPRUNT",corner_radius=20,height= 35,width=79,font=Outfit,text_color="#1C1C1E",fg_color="white",bg_color="white",hover=False,command=ChangementEmprunts).grid(row=2,column=5)
...
def affichage_liste_emprunts():
    ...
    LabelEspace_LA0 = CTkLabel(root, text="",corner_radius=10,height=30,font=Outfit,fg_color="#0A1437").grid(row=4,column=0)
    LabelQuintuple = CTkLabel(root, text="",corner_radius=15,height= 70,width=1025,font=Outfit,text_color="white",fg_color="white").grid(row=5,rowspan=3,column=1,columnspan=10)
    EntryScan = CTkEntry(root, placeholder_text="Scannez le NFC d'un livre",placeholder_text_color="#7882A5",width=370,corner_radius=10,height= 50,font=Outfit,text_color="#1C1C1E",fg_color="#E5EAF8",bg_color="white",border_width=0).grid(row=6,column=1,columnspan=3,padx=(35,0),sticky='w')
    EntryAdherent = CTkEntry(root, placeholder_text="Scannez la carte de l'adhérent",placeholder_text_color="#7882A5",corner_radius=10,height= 50,font=Outfit,text_color="#1C1C1E",fg_color="#E5EAF8",bg_color="white",width=370,border_width=0).grid(row=6,column=2,columnspan=6,sticky='w',padx=(210,0))
    BouttonRetour = CTkLabel(root, text="RETOUR",corner_radius=20,height= 50,width=110,font=Outfit,text_color="#1C1C1E",fg_color="#BAC8EB",bg_color="white").grid(row=6,column=7,columnspan=3, padx=(0,150), sticky='e')
    BouttonAjouter = CTkLabel(root, text="AJOUTER",corner_radius=20,height= 50,width=110,font=Outfit,text_color="#1C1C1E",fg_color="#BAC8EB",bg_color="white").grid(row=6,column=8,columnspan=2, padx=(0,20))
    LabelRetard = CTkLabel(root, text="Livres en retard",corner_radius=15,height= 30,width=115,font=Outfit,text_color="#1C1C1E",fg_color="white").grid(row=9,rowspan=3,column=8,columnspan=2,sticky='w')
    if len(Liste_Emprunt)<=10:
        ...
        if num_liste_affiche==num_liste_max:
            ...
            HauteurDeca=650
    LabelDeca = CTkLabel(root, text="",corner_radius=15,height= HauteurDeca,width=1025,font=Outfit,text_color="white",fg_color="white").grid(row=13,rowspan=22,column=1,columnspan=10,sticky="n")
    Label_Titre_Livre = CTkLabel(root, text="Livre >", text_color="#1C1C1E",fg_color="white",bg_color="white",font=OutfitBold).grid(row=13,column=1,pady=10,sticky="w",padx=(25,0))
    Label_Titre_Auteur = CTkLabel(root, text="Auteur >", text_color="#1C1C1E",fg_color="white",bg_color="white",font=OutfitBold).grid(row=13,column=2,pady=10,sticky="w",padx=(10,0))
    Label_Titre_Adherent = CTkLabel(root, text="Adhérent >", text_color="#1C1C1E",fg_color="white",bg_color="white",font=OutfitBold).grid(row=13,column=3,columnspan=2,pady=10,sticky="w",padx=(10,0))
    Label_Titre_Retour = CTkLabel(root, text="Retour >", text_color="#1C1C1E",fg_color="white",bg_color="white",font=OutfitBold).grid(row=13,column=5,columnspan=2,pady=10,sticky="w",padx=(10,0))
    Label_Titre_Identifiant = CTkLabel(root, text="Identifiant >", text_color="#1C1C1E",fg_color="white",bg_color="white",font=OutfitBold).grid(row=13,column=7,columnspan=2,pady=10,sticky="w",padx=(10,0))
    progressbar = CTkProgressBar(root,height=1,width=1040,fg_color="#E6E6E6",progress_color="#E6E6E6",border_width=0).grid(row=14, column=1,columnspan=10)
    if len(Liste_Emprunt)<=10:
        for i in range(len(Liste_Emprunt)):
            ...
            LabelAuteur=CTkLabel(root,wraplength=180, text=Liste_Emprunt[i][2] ,text_color="#1C1C1E",fg_color="white",bg_color="white",height=40,font=Outfit).grid(row=15+2*i,column=2,sticky="nw",padx=(10,0))
            LabelAdherent=CTkLabel(root,wraplength=180, text=Liste_Emprunt[i][3] ,text_color="#1C1C1E",fg_color="white",bg_color="white",height=40,font=Outfit).grid(row=15+2*i,column=3,columnspan=2,sticky="nw",padx=(10,0))
            LabelRetour=CTkLabel(root,wraplength=180, text=Liste_Emprunt[i][4] ,text_color="#1C1C1E",fg_color="white",bg_color="white",height=40,font=Outfit).grid(row=15+2*i,column=5,columnspan=2,sticky="nw",padx=(10,0))
            LabelIdentifiant=CTkLabel(root,wraplength=180, text=Liste_Emprunt[i][0] ,text_color="#1C1C1E",fg_color="white",bg_color="white",height=40,font=Outfit).grid(row=15+2*i,column=7,columnspan=2,sticky="nw",padx=(10,0))
...
Liste_Emprunt = [("Harry Potter à l’école des...","7809567556","Auxane Salmero","23/05/23","1847392749"),("Harry Potter à l’école des...","7809567556","Auxane Salmero","23/05/23","1847392749"),("Harry Potter à l’école des...","7809567556","Auxane Salmero","23/05/23","1847392749"),("Harry Potter à l’école des...","7809567556","Auxane Salmero","23/05/23","1847392749"),("Harry Potter à l’école des...","7809567556","Auxane Salmero","23/05/23","1847392749"),("Harry Potter à l’école des...","7809567556","Auxane Salmero","23/05/23","1847392749"),("Harry Potter à l’école des...","7809567556","Auxane Salmero","23/05/23","1847392749"),("Harry Potter à l’école des...","7809567556","Auxane Salmero","23/05/23","1847392749"),("Harry Potter à l’école des...","7809567556","Auxane Salmero","23/05/23","1847392749"),("Harry Potter à l’école des...","7809567556","Auxane Salmero","23/05/23","1847392749"),("Harry Potter à l’école des...","7809567556","Auxane Salmero","23/05/23","1847392749")]
...
def Previous_Page():
    ...
    if page=="adherent":
        ...
        Liste_Emprunt_Affiche=[]
        for i in range((num_liste_affiche-1)*10,(num_liste_affiche-1)*10+11):
            Liste_Emprunt_Affiche.append(Liste_Livre[i])
        clear_frame()
        affichage_menu()
        affichage_liste_emprunts()
def Next_Page():
    ...
    if page=="adherent":
        ...
        if num_liste_affiche<num_liste_max:
            Liste_Emprunt_Affiche=[]
            for i in range((num_liste_affiche-1)*10,(num_liste_affiche-1)*10+11):
                Liste_Emprunt_Affiche.append(Liste_Emprunt[i])
        else:
            Liste_Emprunt_Affiche=[]
            max= len(Liste_Emprunt)%10
            if max==0:
