...
def Ajouter_Livre():
    ...
    requete='INSERT INTO livre(isbn,titre,auteur,editeur,categorie) VALUES("'+str(isbn)+'","'+str(titre)+'","'+Edit_Nb_Auteur(str(auteur))+'","'+Edit_Nb_Auteur(str(editeur))+'","'+str(categorie)+'")'
    curseur.execute(requete)
    connexion.commit()
...
def Ajouter_Adherent():
    ...
    requete='INSERT INTO adherent(nomAdherent,prenomAdherent,adresse,telephone) VALUES("'+nom.upper()+'","'+prenom.upper()+'","'+adresse.upper()+'","'+Telephone.upper() +'")'
    curseur.execute(requete)
    connexion.commit()
